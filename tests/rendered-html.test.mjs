...
test("renders a crawlable blog index with category navigation", async () => {
  ...
  assert.match(html, /href="\/blog\/tem-phu-san-pham-bo-cuc-de-doc"/i);
  assert.match(html, /href="\/blog\/sticker-trang-tri-chon-kich-thuoc-va-be-mat-dan"/i);
  ...
  assert.match(html, /\/images\/blog\/tem-phu-san-pham-de-doc\.webp/i);
  assert.match(html, /\/images\/blog\/sticker-trang-tri-chon-kich-thuoc\.webp/i);
...
test("publishes an RSS feed for public blog articles", async () => {
  ...
  assert.match(xml, /https:\/\/vinprint\.vn\/blog\/tem-phu-san-pham-bo-cuc-de-doc/i);
  assert.match(xml, /https:\/\/vinprint\.vn\/blog\/sticker-trang-tri-chon-kich-thuoc-va-be-mat-dan/i);
});
...
test("all public routes render successfully", async () => {
  const routes = [
    ...
    "/blog/tem-phu-san-pham-bo-cuc-de-doc",
    "/blog/sticker-trang-tri-chon-kich-thuoc-va-be-mat-dan",
...
test("sitemap publishes the blog hub and every GEO article", async () => {
  ...
  assert.match(xml, /https:\/\/vinprint\.vn\/blog\/tem-phu-san-pham-bo-cuc-de-doc<\/loc>/i);
  assert.match(xml, /https:\/\/vinprint\.vn\/blog\/sticker-trang-tri-chon-kich-thuoc-va-be-mat-dan<\/loc>/i);
