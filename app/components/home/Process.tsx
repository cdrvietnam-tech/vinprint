...
export default function Process() {
  const steps = [
    { icon: MessageSquare, title: "Gửi yêu cầu", desc: "Điền vật liệu, kích thước và số lượng" },
    { icon: Calculator, title: "Nhận báo giá", desc: "Chọn báo giá lẻ hoặc sỉ theo nhu cầu" },
