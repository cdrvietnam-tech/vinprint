        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="lg:w-[45%] text-center lg:text-left z-10 mt-4">
            ...
            <motion.h1 
              ...
              className="text-5xl lg:text-[60px] xl:text-[72px] font-black tracking-tight text-gray-900 mb-6 leading-[1.25]"
            >
              <span className="whitespace-nowrap">XƯỞNG IN SIÊU TỐC</span><br/>
          ...
          <div className="lg:w-[55%] relative w-full h-[600px] hidden lg:block">
            <motion.div
            ...
            >
              <div className="w-full h-full relative flex items-center justify-center">
                  <div className="w-full h-full relative flex items-center justify-center">
                    ...
                    <motion.div animate={{ opacity: [0, 1, 0], scale: [0.5, 1.5, 0.5], rotate: [0, 90, 180] }} transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }} className="absolute top-10 right-10 w-10 h-10 text-[#F5A623] drop-shadow-[0_0_20px_rgba(245,166,35,1)] z-10">
                    ...
                    <motion.div animate={{ opacity: [0, 1, 0], scale: [0.4, 1.4, 0.4], rotate: [0, -90, -180] }} transition={{ duration: 1.8, repeat: Infinity, ease: "easeInOut", delay: 0.3 }} className="absolute bottom-20 right-5 w-8 h-8 text-[#F5A623] drop-shadow-[0_0_20px_rgba(245,166,35,1)] z-10">
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L14.4 9.6L22 12L14.4 14.4L12 22L9.6 14.4L2 12L9.6 9.6L12 2Z" fill="currentColor"/></svg>
                    </motion.div>
                    <motion.div animate={{ opacity: [0, 1, 0], scale: [0.6, 1.6, 0.6], rotate: [0, 180, 360] }} transition={{ duration: 1.2, repeat: Infinity, ease: "easeInOut", delay: 0.6 }} className="absolute top-1/3 left-10 w-6 h-6 text-[#F5A623] drop-shadow-[0_0_20px_rgba(245,166,35,1)] z-10">
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L14.4 9.6L22 12L14.4 14.4L12 22L9.6 14.4L2 12L9.6 9.6L12 2Z" fill="currentColor"/></svg>
                    </motion.div>
                    <motion.div animate={{ opacity: [0, 1, 0], scale: [0.5, 1.3, 0.5], rotate: [0, -180, -360] }} transition={{ duration: 1.6, repeat: Infinity, ease: "easeInOut", delay: 0.2 }} className="absolute bottom-1/3 right-1/4 w-7 h-7 text-[#F5A623] drop-shadow-[0_0_20px_rgba(245,166,35,1)] z-10">
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L14.4 9.6L22 12L14.4 14.4L12 22L9.6 14.4L2 12L9.6 9.6L12 2Z" fill="currentColor"/></svg>
                    </motion.div>
                    <motion.div animate={{ opacity: [0, 1, 0], scale: [0.7, 1.4, 0.7], rotate: [0, 90, 180] }} transition={{ duration: 1.4, repeat: Infinity, ease: "easeInOut", delay: 0.8 }} className="absolute top-0 right-1/2 w-9 h-9 text-[#F5A623] drop-shadow-[0_0_20px_rgba(245,166,35,1)] z-10">
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L14.4 9.6L22 12L14.4 14.4L12 22L9.6 14.4L2 12L9.6 9.6L12 2Z" fill="currentColor"/></svg>
                    </motion.div>
                    ...
                    <motion.div 
                      ...
                      className="absolute top-[65%] left-[-10px] w-12 h-12 text-[#8B5CF6] z-20"
                    >
                    ...
                    <img src="/images/hero-collage.png" alt="Bộ sưu tập tem nhãn VinPrint" className="w-full h-full object-contain drop-shadow-2xl scale-[1.3]" />
                  </div>

                  {/* Floating Badges (Left stacked) */}
                  <div className="absolute left-[-40px] xl:left-[-120px] top-[40%] flex flex-col gap-4 z-20 scale-90 lg:scale-100 origin-left">
                  ...
                  <motion.div 
                    ...
                    className="absolute top-1/4 right-[-10px] bg-white px-5 py-4 rounded-2xl shadow-xl border border-gray-100 flex flex-col items-center z-20 text-center w-40"
                  >
