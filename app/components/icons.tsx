...
export function StarIcon(props: IconProps) {
  return (
    <svg {...defaults} fill="currentColor" stroke="none" {...props}>
      <path d="m12 2.8 2.82 5.72 6.31.92-4.57 4.45 1.08 6.28L12 17.2l-5.64 2.97 1.08-6.28-4.57-4.45 6.31-.92L12 2.8Z" />
    </svg>
  );
}
...
export function ZaloIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
