...
import { blogCategories, getBlogCategoryLabel, type BlogCategorySlug } from "../../../lib/blog-posts";
...
export default async function BlogCategoryPage({ params }: { params: Promise<{ category: string }> }) {
  ...
  const posts = (await getManagedBlogPosts()).filter((post) => post.category === category);
