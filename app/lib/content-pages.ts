...
export const industryPages: Record<string, ContentPageData> = {
  ...
  "do-uong": { slug: "do-uong", title: "In tem nhãn đồ uống cho chai và ly lạnh", description: "Chọn tem cho ly cà phê, chai nước và đồ uống lạnh theo bề mặt dán, độ ẩm và kích thước. Gửi mẫu bao bì để VinPrint tư vấn quy cách và báo giá.", eyebrow: "Theo ngành · Đồ uống", intro: "Đặt in tem cho chai hoặc ly đồ uống bắt đầu từ bao bì thật: bề mặt dán, kích thước và điều kiện bảo quản. VinPrint nhận thông tin mẫu để tư vấn vật liệu và báo giá theo quy cách của từng đơn.", sections: [
    { heading: "Chọn tem theo bao bì và điều kiện sử dụng", paragraphs: ["Với ly cà phê đá hoặc chai nước bảo quản lạnh, hãy mô tả cả hơi nước đọng ngoài bao bì, thời gian bảo quản và cách vận chuyển. Cần xem xét vật liệu tem, lớp keo và bề mặt dán cùng nhau; tên gọi chống nước chưa đủ để khẳng định tem phù hợp với mọi loại ly.", "Decal nhựa là lựa chọn cần cân nhắc khi bao bì tiếp xúc ẩm. Nếu nhãn dùng trên túi hoặc hộp khô, nhu cầu vật liệu có thể khác. Độ bám vẫn cần thử trên đúng bao bì trước khi chốt."], links: [{ href: "/san-pham/tem-nhua-chong-nuoc", label: "Xem tem nhựa chống nước" }, { href: "/san-pham/tem-giay", label: "Tham khảo tem giấy cho bao bì khô" }] },
    { heading: "Gửi gì để nhận tư vấn và báo giá?", paragraphs: ["Thông tin càng rõ, xưởng càng dễ đối chiếu quy cách. Nếu chưa chốt kích thước, gửi ảnh vùng dán cùng vật đo để trao đổi trước khi làm file."], bullets: ["Ảnh chai hoặc ly thật và vị trí dự định dán", "Kích thước tem, hình dạng và số mẫu", "Số lượng từng mẫu và yêu cầu giao tem", "Bao bì dùng thường hay làm lạnh; dán trước hay sau khi làm lạnh", "Logo, nội dung từng vị và file thiết kế nếu có"], links: [{ href: "/huong-dan/chon-kich-thuoc-tem", label: "Hướng dẫn đo kích thước tem" }, { href: "/blog/chuan-bi-file-in-tem-khong-bi-mo", label: "Chuẩn bị file trước khi gửi in" }] },
    { heading: "Kiểm tra mẫu trên chai và ly thật", paragraphs: ["Dán thử trên bề mặt sạch, khô theo hướng dẫn của vật liệu được chọn. Quan sát mép tem, độ rõ của chữ và biểu hiện sau khi đặt trong điều kiện sử dụng dự kiến. Nếu thấy nhăn, bong hoặc khó đọc, điều chỉnh mẫu trước khi đặt số lượng lớn.", "Logo, tên vị và dung tích nên có thứ bậc rõ; kiểm tra độ tương phản ở kích thước thật. Giá, quy cách và thời gian thực hiện được xác nhận riêng cho từng đơn."], links: [{ href: "/blog/tem-ly-ca-phe-chong-nuoc", label: "Cách kiểm tra tem ly cà phê từ lúc dán đến khi giao" }, { href: "/blog/thu-tem-trong-moi-truong-lanh", label: "Hướng dẫn thử tem trong môi trường lạnh" }] },
  ]},
